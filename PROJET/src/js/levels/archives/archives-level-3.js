export default {
    ...
    dirs: {
        "/home/player": ["desktop", "downloads", ".secrets"],
    ...
    files: {
        "/home/player/desktop/todo.txt": "Rien ici",
        "/home/player/downloads/music.txt": "Toujours rien",
        "/home/player/.secrets/private/flag.txt": "FLAG{archives_3}"
    },
    answer: "FLAG{archives_3}",
    aliases: [],
    success: "Tu as trouvé le dossier caché.",
    fail: "Le flag est incorrect.",
    explain: "Le dossier .secrets était caché, il fallait utiliser ls -a pour le voir."
};